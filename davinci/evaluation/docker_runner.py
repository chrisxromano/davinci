"""
Docker-based ONNX model execution for GPR rebar detection.
...
Input: (N, 1, depth, width) float32 GPR scan windows
Output: (N,) or (N, 1) binary predictions (labels 0/1 or probabilities)
"""
...
class DockerConfig:
    ...
    image: str = "davinci-onnx-runner:latest"
...
class DockerRunner:
    ...
    def _ensure_image(self) -> None:
        ...
        try:
            ...
            raise DockerImageError(
                ...
                f"Build it with: docker build -t {self._config.image} davinci/evaluation/"
            ) from e
    ...
    def run_inference(
        ...
        Args:
            ...
            input_data: GPR scan windows as numpy array (N, 1, depth, width)
    ...
    def _validate_predictions(
        ...
        """Validate and normalize predictions for binary classification."""
        # Flatten if needed
