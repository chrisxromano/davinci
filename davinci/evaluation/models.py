...
class PredictionMetrics:
    """
    Classification metrics for a model's rebar detection predictions.

    All ratio metrics are in 0.0-1.0 range.
    """

    # Classification metrics (higher is better, 0.0-1.0)
    ...
    def score(self) -> float:
        ...
        Uses F1 score — balances precision and recall for rebar detection.
        """
        return self.f1
