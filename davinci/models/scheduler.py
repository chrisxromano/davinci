...
class ModelDownloadScheduler:
    ...
    def get_available_models(
        ...
        4. Have a verified block number (block_number != 0)
    ...
    async def run_pre_download(
        ...
        to_download = self._filter_needs_download(commitments)
    ...
    def _filter_needs_download(
        ...
        Skips models already cached with matching hash.
        """
        needs_download = [
            c
        ...
        logger.info(
            ...
            f"{len(commitments) - len(needs_download)} already cached"
        )
