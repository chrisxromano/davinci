...
if TYPE_CHECKING:
    from davinci.duplicate_detector import DuplicateDetectionResult
    from davinci.evaluation import EvaluationBatch
    from davinci.incentives import IncentiveWeights, WinnerSelectionResult
        ...
        return {
            ...
            "results": {
                r.hotkey: {
                    ...
                    "f1": round(r.metrics.f1, 6) if r.metrics else None,
                    "success": r.success,
