...
class TestRetryLogic:
    ...
    async def test_retries_on_http_error(
        ...
        with patch(
            "davinci.models.downloader.hf_hub_download", side_effect=mock_download
        ):
    ...
    async def test_exponential_backoff_delays(
        ...
        with (
            ...
            patch(
                "davinci.models.downloader.hf_hub_download",
...
class TestDownloadModel:
    ...
    async def test_cleans_up_temp_file_on_hash_failure(
        ...
        from davinci.models import HashMismatchError
